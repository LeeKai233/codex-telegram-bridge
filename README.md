...
The v0.3.2 installer intentionally has a narrow host contract:
...
4. Installs Bridge v0.3.2 into `~/.local/bin` from the matching immutable Git tag.
...
The bootstrap downloads the immutable `v0.3.2` release asset to a temporary file, verifies the
